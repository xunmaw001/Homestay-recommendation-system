...
<html>
	...
	<body>
	<div id="apps">
		<div id="header" :style='{"padding":"0px","margin":"0 auto","alignItems":"center","display":"flex","right":"0","justifyContent":"space-between","overflow":"hidden","top":"0","left":"0","background":"#a1c842","width":"100%","position":"fixed","height":"44px","zIndex":"1002"}'>
			...
			<div v-if="projectName" :style='{"margin":"0 0 0 180px","color":"#333","textAlign":"center","background":"none","width":"calc(100% - 360px)","lineHeight":"44px","fontSize":"18px","height":"44px"}' class="nav-top-title">{{projectName}}</div>
		...
		<div id="navs" class="horizontal" :style='{"width":"100%","padding":"0","margin":"44px auto 0","textAlign":"center","background":"#ebebf3","height":"auto"}'>
			<ul class="layui-nav" lay-bar="disabled" :style='{"border":"0","padding":"0 0 30px","listStyle":"none","margin":"0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230112/04f09805676347b69686b77e068e3b89.png) no-repeat center bottom","width":"100%","position":"fixed","zIndex":"999"}'>
		...
		<div id="tabbar" class="tabbar" :style='{"padding":"50px 50px 0","margin":"0 auto","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230112/945970528aee445e83fe30c9962339f7.jpg) no-repeat center top / 100% auto,#ffc303","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"220px"}'>
