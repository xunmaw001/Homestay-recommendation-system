	...
	<body>
		...
		<div id="app">
			...
			<div class="forum-container">
				<form :style='{"boxShadow":"0 0px 0px 0 rgba(0, 0, 0, .1)","padding":"15px 0","margin":"0px 0 0px","borderColor":"#fff","borderWidth":"0px","background":"none","width":"100%","borderStyle":"dotted"}' class="layui-form message-form">
				...
				<div :style='{"boxShadow":"0 0px 0px 0 rgba(0, 0, 0, .1)","padding":"15px 0","borderColor":"#fff","borderWidth":"0px","background":"none","width":"100%","borderStyle":"groove"}' class="message-list" v-if="dataList.length">
					<div :style='{"padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 20px","borderColor":"#ddd","alignItems":"center","borderRadius":"4px","borderWidth":"0px","background":"none","width":"100%","borderStyle":"solid","height":"auto"}' class="message-item" v-for="(item,index) in dataList" v-bind:key="index" >
						...
						<div :style='{"padding":"8px","boxShadow":"rgb(75 223 201 / 30%) 0px 0px 0px","margin":"10px 0px 0px","borderColor":"#c7eec2","color":"#333","borderRadius":"0px","background":"none","borderWidth":"0px","lineHeight":"30px","fontSize":"14px","borderStyle":"solid","textIndent":"2em"}' v-if="item.reply" class="replay">
							回复：{{item.reply}}
						</div>
