		...
		<script>
			...
			layui.use(['form', 'layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate', 'slider'], function() {
				...
				if (jquery('#yonghuxingming').val()) {
					...
					// 获取列表数据
					http.request('fangjianyuding/list', 'get', param, function(res) {
