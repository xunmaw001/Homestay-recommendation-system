...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">近期活动管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>近期活动列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>民宿名称</label>
					<input type="text" id="minsumingchengSearch" class="form-control form-control-sm" placeholder="请输入民宿名称" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>地区</label>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th>图片</th>
						<th onclick="sort('minsumingcheng')">民宿名称<i id="minsumingchengIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#minsumingchengSearch').val() != null && $('#minsumingchengSearch').val() != ''){
				searchForm.minsumingcheng ="%" +  $('#minsumingchengSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("jinqihuodong/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				minsumingcheng : searchForm.minsumingcheng,	
		...
		function setDataRow(item,number){
			...
			var minsumingchengCell  = document.createElement('td');

						 minsumingchengCell.innerHTML = item.minsumingcheng;

			row.appendChild(minsumingchengCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jinqihuodong/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"jinqihuodong");
