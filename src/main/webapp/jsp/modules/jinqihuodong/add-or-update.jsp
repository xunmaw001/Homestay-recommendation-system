...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑近期活动</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>近期活动管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑近期活动</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>活动编号</label>
					<input name="huodongbianhao" id="huodongbianhao" name="huodongbianhao" class="form-control" placeholder="请输入活动编号">
				</div>
				<div class="form-item">
					<label>活动标题</label>
					<input name="huodongbiaoti" id="huodongbiaoti" name="huodongbiaoti" class="form-control" placeholder="请输入活动标题">
				</div>
				...
				<div class="form-item">
					<label>民宿名称</label>
					<input name="minsumingcheng" id="minsumingcheng" name="minsumingcheng" class="form-control" placeholder="请输入民宿名称">
				</div>
				<div class="form-item">
					<label>地区</label>
				...
				<div class="form-item">
					<label>活动时间</label>
					<input id="huodongshijian-input" class="date" name="huodongshijian" size="15" type="text" readonly placeholder="请选择活动时间">
				</div>
				<div class="form-item">
					<label>员工工号</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jinqihuodong/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("jinqihuodong/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("jinqihuodong/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jinqihuodong/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#huodongshijian-input").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.minsumingcheng != null && res.data.minsumingcheng != ''){
							$('#minsumingcheng').val(res.data.minsumingcheng)
							$("#minsumingcheng").attr('readonly','readonly');
						}
		...
		function dataBind(){
			...
			$("#minsumingcheng").val(ruleForm.minsumingcheng);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.minsumingcheng != null && res.data.minsumingcheng != ''){
