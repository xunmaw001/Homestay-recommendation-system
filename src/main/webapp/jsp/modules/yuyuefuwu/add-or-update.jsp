...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑预约服务</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>预约服务管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑预约服务</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>时间</label>
					<input id="shijian-input" class="date" name="shijian" size="15" type="text" readonly placeholder="请选择时间">
				</div>
				<div class="form-item">
					<label>服务项目</label>
	...
	<script>
				...
				if(crossrefid && crossuserid) {
					...
					http("yuyuefuwu/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("yuyuefuwu/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yuyuefuwu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
