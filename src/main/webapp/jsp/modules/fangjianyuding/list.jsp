...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">房间预定管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>房间预定列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('ruzhushijian')">入住时间<i id="ruzhushijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var ruzhushijianCell  = document.createElement('td');

						  ruzhushijianCell.innerHTML = item.ruzhushijian;


			row.appendChild(ruzhushijianCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "预约服务"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'yuyuefuwu','','','')");
			if(crossBtnControl('预约服务') == true){
				btnGroup.appendChild(crossBtn0);
			}   
			var crossBtn1 = document.createElement('button');
            		crossBtn1.innerHTML = "退房结账"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'tuifangjiezhang','','[1]','己提交')");
			if(crossBtnControl('退房结账') == true){
