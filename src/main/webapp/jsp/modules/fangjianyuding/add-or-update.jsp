...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑房间预定</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>房间预定管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑房间预定</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>客房类型</label>
					<input name="kefangleixing" id="kefangleixing" name="kefangleixing" class="form-control" placeholder="请输入客房类型">
				</div>
				<div class="form-item">
					<label>价格</label>
				...
				<div class="form-item">
					<label>入住时间</label>
					<input id="ruzhushijian-input" class="date" name="ruzhushijian" size="15" type="text" readonly placeholder="请选择入住时间">
				</div>
				<div class="form-item">
					<label>用户账号</label>
	...
	<script>
				...
				if(crossrefid && crossuserid) {
					...
					http("fangjianyuding/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("fangjianyuding/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("fangjianyuding/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#ruzhushijian-input").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function dataBind(){
			...
			$("#ruzhushijian-input").val(ruleForm.ruzhushijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.ruzhushijian != null && res.data.ruzhushijian != ''){

						$("#ruzhushijian-input").val(res.data.ruzhushijian);
						$('#ruzhushijianFileName').val(res.data.ruzhushijian)
					}
