...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑民宿员工</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>民宿员工管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑民宿员工</span></li>
			</ol>
		</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "minsuyuangong/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("minsuyuangong/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("minsuyuangong/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("minsuyuangong/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("minsuyuangong"+colName,"GET",{
