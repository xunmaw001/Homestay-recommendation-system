...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑退房结账</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>退房结账管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑退房结账</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>入住天数</label>
					<input id="ruzhutianshu" name="ruzhutianshu" class="form-control" onchange="calculation()" placeholder="请输入入住天数">
				</div>
				<div class="form-item">
					<label>费用总计</label>
					<input name="feiyongzongji" id="feiyongzongji" name="feiyongzongji" class="form-control" placeholder="请输入费用总计">
				</div>
				<div class="form-item">
					<label>入住时间</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "tuifangjiezhang/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("tuifangjiezhang/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("tuifangjiezhang/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("tuifangjiezhang/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculation(){
			...
			if(flag < 2){
				...
				$("#feiyongzongji").val(x.toFixed(2));
			}

		}		
		function calculationSE(colName){
			//单列求和接口
			http("tuifangjiezhang"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#feiyongzongji").val(ruleForm.feiyongzongji);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.ruzhutianshu != null && res.data.ruzhutianshu != ''){
						...
						$("#ruzhutianshu").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.feiyongzongji != null && res.data.feiyongzongji != ''){

						$("#feiyongzongji").val(res.data.feiyongzongji);
						$("#feiyongzongji").attr('readonly','readonly');
					}
