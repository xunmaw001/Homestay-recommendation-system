		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="ruzhutianshu" name="ruzhutianshu" class="form-control" v-model="ruleForm.ruzhutianshu" readonly>
				</div>
				<div class="form-item">
					<label>费用总计</label>

					<input id="feiyongzongji" name="feiyongzongji" class="form-control" v-model="ruleForm.feiyongzongji" readonly>
				</div>
				<div class="form-item">
					<label>入住时间</label>

					<input id="ruzhushijian" name="ruzhushijian" class="form-control" v-model="ruleForm.ruzhushijian" readonly>
				</div>
				<div class="form-item">
					<label>用户账号</label>
