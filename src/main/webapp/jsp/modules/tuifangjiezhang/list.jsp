...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">退房结账管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>退房结账列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('ruzhutianshu')">入住天数<i id="ruzhutianshuIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('feiyongzongji')">费用总计<i id="feiyongzongjiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var feiyongzongjiCell  = document.createElement('td');

						 feiyongzongjiCell.innerHTML = item.feiyongzongji;

			row.appendChild(feiyongzongjiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("tuifangjiezhang/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"tuifangjiezhang");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"tuifangjiezhang");
