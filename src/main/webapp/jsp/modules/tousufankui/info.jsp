		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item-file">
					<label>反馈意见</label>
					<script id="fankuiyijianEditor" type="text/plain" style="width:800px;height:230px;"></script>
				...
				<div class="form-item-file">
					<label>评价意见</label>
					<script id="pingjiayijianEditor" type="text/plain" style="width:800px;height:230px;"></script>
					<script type="text/javascript">
						//建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
						//相见文档配置属于你自己的编译器
