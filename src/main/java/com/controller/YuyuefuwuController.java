...
public class YuyuefuwuController {
    ...
    public R page(@RequestParam Map<String, Object> params,YuyuefuwuEntity yuyuefuwu, 
		...
		if(tableName.equals("yonghu")) {
			yuyuefuwu.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("minsuyuangong")) {
			yuyuefuwu.setYuangonggonghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YuyuefuwuEntity> wrapper = new EntityWrapper<YuyuefuwuEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = yuyuefuwuService.selectCount(wrapper);
